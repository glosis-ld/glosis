...
if __name__ == "__main__":
    ...
    postprocessor = oneOf_postprocess.PostProcessor(input_csv=input_csv, output_ttl=output_ttl, temp=temp)
    postprocessor.run()
    header_appender = header_appender.HeaderAppender(input_ttl=output_ttl, input_csv=input_csv, version=version)
    header_appender.run()
